...
import { faBed, faCar, faMountain, faPerson, faPlane, faTaxi } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <div className="header">
            <div className={type === "hotels" ? "headerContainer hotelsMode" : "headerContainer"}>
                ...
                { type !== "hotels" && <><h1 className="headerTitle">A lifetime of discounts? It's Genius</h1>
                <p className="headerDescription"> Get rewarded for your travels – unlock instant savings of 10% or
